...
tinymce.init({
    ...
    contextmenu: "removeformat bold italic underline link image table",
    contextmenu_never_use_native: true,
    toolbar_mode: "sliding", // wrap floating sliding
    toolbar:
        " undo redo restoredraft | forecolor backcolor fontsizeinput | fontfamily styles | bold italic underline removeformat | alignleft aligncenter alignright | alignjustify outdent indent bullist numlist | table tabledelete | image insertdatetime link unlink openlink | cut paste wordcount",
