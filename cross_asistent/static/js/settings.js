...
$(document).ready(function () {
    try {
        ...
        // Traducir nombre del color a codigo
        const colorMap = {
            black: "#000000",
            negro: "#000000",
            white: "#FFFFFF",
        ...
        alertSToast("center", 8000, "error", `😥 Ah ocurrido un error JQ. Codigo de error #304`);
    }
});
