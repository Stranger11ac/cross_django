    ...
    if request.method == 'POST':
        try:
            ...
            if mejor_coincidencia:
                ...
                system_prompt = f"Eres Hawky, un asistente de la Universidad Tecnologica de Coahuila. Utiliza alguno emojis sutilmente. Responde la pregunta con esta información: {informacion}"
